...
export class compendiumBrowser extends Application {
    constructor(options = {}) {
        super(options), this.dataTabsList = ["abilities", "bestiary", "acquis", "races", "castes", "people", "jobs"], this.packLoader = new PackLoader, this.settings = game.settings.get("shaanrenaissance", "compendiumBrowserPacks"), this.navigationTab = this.hookTab(), this.tabs = {
    ...
    hookTab() {
        ...
        return navigationTab.callback = async (event, tabs, active) => {
    ...
    initCompendiumList() {
            ...
            for (const pack of game.packs) {
                ...
                if(0 !== types.size) {
                    if(types.has("Pouvoir")) {
                        const load = null === (_c = null === (_b = null === (_a = this.settings.abilities) || void 0 === _a ? void 0 : _a[pack.collection]) || void 0 === _b ? void 0 : _b.load) && void 0 === _c ? _c : !!loadDefault[pack.collection];
                    ...
                    if(types.has("Caste")) {
                        const load = null === (_j = null === (_h = null === (_g = this.settings.castes) || void 0 === _g ? void 0 : _g[pack.collection]) || void 0 === _h ? void 0 : _h.load) && void 0 !== _j ? _j : !!loadDefault[pack.collection];
                    ...
                    if(types.has("Métier")) {
                        const load = null === (_m = null === (_l = null === (_k = this.settings.jobs) || void 0 === _k ? void 0 : _k[pack.collection]) || void 0 === _l ? void 0 : _l.load) && void 0 !== _m ? _m : !!loadDefault[pack.collection];
                    ...
                    if(types.has("Race")) {
                        const load = null === (_q = null === (_p = null === (_o = this.settings.races) || void 0 === _o ? void 0 : _o[pack.collection]) || void 0 === _p ? void 0 : _p.load) && void 0 !== _q ? _q : !!loadDefault[pack.collection];
                    ...
                    if(types.has("Peuple")) {
                        const load = null === (_t = null === (_s = null === (_r = this.settings.people) || void 0 === _r ? void 0 : _r[pack.collection]) || void 0 === _s ? void 0 : _s.load) && void 0 !== _t ? _t : !!loadDefault[pack.collection];
        ...
        for (const tab of this.dataTabsList) settings[tab] = Object.fromEntries(Object.entries(settings[tab]).sort((([_collectionA, dataA], [_collectionB, dataB]) => {
            var _a, _b;
            return (null !== (_a = null == dataA ? void 0 : dataA.name) && void 0 !== _a ? _a : "") > (null !== (_b = null == dataB ? void 0 : dataB.name) && void 0 !== _b ? _b : "") ? 1 : -1
        })));
    ...
    async loadTab(tabName) {
        ...
        currentTab.isInitialized || await currentTab.init(), await this.render(!0, {
            focus: !0
        })
    }
    loadedPacks(tab) {
        var _a;
        return "settings" === tab ? [] : Object.entries(null !== (_a = this.settings[tab]) && void 0 !== _a ? _a : []).flatMap((([collection, info]) => (null == info ? void 0 : info.load) ? [collection] : []))
    }
    activateListeners($html) {
        ...
        const html = $html[0],
            ...
            if (this.navigationTab.active !== activeTabName && this.navigationTab.activate(activeTabName), "settings" === activeTabName) {
                const form = html.querySelector(".compendium-browser-settings form");
                return void(form && (null === (_a = form.querySelector("button.save-settings")) || void 0 === _a || _a.addEventListener("click", (async () => {
            ...
            search && search.addEventListener("input", (() => {
                currentTab.filterData.search.text = search.value, this.clearScrollLimit(), this.renderResultList({
                    replace: !0
                })
            }));
            ...
            if (sortContainer) {
                ...
                order && order.addEventListener("change", (() => {
                    var _a;
                ...
                directionAnchor && directionAnchor.addEventListener("click", (() => {
                    var _a;
            ...
            null === (_b = controlArea.querySelector("button.clear-filters")) || void 0 === _b || _b.addEventListener("click", (() => {
            ...
            for (const container of Array.from(filterContainers)) {
                ...
                null === (_c = container.querySelector("button[data-action=clear-filter]")) || void 0 === _c || _c.addEventListener("click", (event => {
                    switch (event.stopImmediatePropagation(), filterType) {
                        ...
                        case "ranges":
                            if (currentTab.isOfType("acquis")) {
                                ...
                                (0, objectHasKey)(ranges, filterName) && (ranges[filterName].values = currentTab.defaultFilterData.ranges[filterName].values, ranges[filterName].changed = !1, this.render(!0))
                            }
                    }
                }));
                const title = container.querySelector("div.title");
                if (null == title || title.addEventListener("click", (() => {
                        const toggleFilter = filter => {
                            filter.isExpanded = !filter.isExpanded;
                            const contentElement = title.nextElementSibling;
                            contentElement instanceof HTMLElement && (filter.isExpanded ? contentElement.style.display = "" : contentElement.style.display = "none")
                        };
                        switch (filterType) {
                            case "checkboxes":
                                (0, objectHasKey)(currentTab.filterData.checkboxes, filterName) && toggleFilter(currentTab.filterData.checkboxes[filterName]);
                                break;
                            case "ranges":
                                if (!currentTab.isOfType("equipment")) return;
                                (0, objectHasKey)(currentTab.filterData.ranges, filterName) && toggleFilter(currentTab.filterData.ranges[filterName]);
                                break;
                        }
                    })), "checkboxes" === filterType && container.querySelectorAll("input[type=checkbox]").forEach((checkboxElement => {
                        checkboxElement.addEventListener("click", (() => {
                            if ((0, objectHasKey)(currentTab.filterData.checkboxes, filterName)) {
                                ...
                                option.selected = !option.selected, option.selected ? checkbox.selected.push(optionName) : checkbox.selected = checkbox.selected.filter((name => name !== optionName)), this.clearScrollLimit(!0)
                            }
                        }))
                    })), "ranges" === filterType && container.querySelectorAll("input[name*=Bound]").forEach((range => {
                        range.addEventListener("keyup", (event => {
                            ...
                            if (ranges && (0, objectHasKey)(ranges, filterName)) {
                                const range = ranges[filterName],
                                    lowerBound = null !== (_b = null === (_a = container.querySelector("input[name*=lowerBound]")) || void 0 === _a ? void 0 : _a.value) && void 0 !== _b ? _b : "",
                                    upperBound = null !== (_d = null === (_c = container.querySelector("input[name*=upperBound]")) || void 0 === _c ? void 0 : _c.value) && void 0 !== _d ? _d : "",
            ...
            const list = html.querySelector(".tab.active ul.item-list");
                list && (list.addEventListener("scroll", (() => {
                    ...
                    if (list.scrollTop + list.clientHeight >= list.scrollHeight - 5) {
                        ...
                        currentValue < maxValue && (currentTab.scrollLimit = Math.clamped(currentValue + 100, 100, maxValue), this.renderResultList({
                            list,
                            start: currentValue
                        }))
                    }
        ...
        activateResultListeners(liElements = []) {
            ...
            for (const liElement of liElements) {
                ...
                nameAnchor && nameAnchor.addEventListener("click", (async () => {
                    const document = await fromUuid(entryUuid);
                    (null == document ? void 0 : document.sheet) && document.sheet.render(!0)
                }))
                , "acquis" === this.activeTab && (null === (_a = liElement.querySelector("a[data-action=take-item]")) || void 0 === _a || _a.addEventListener("click", (() => {
        ...
        async takeAcquisItem(uuid) {
            ...
            if (0 !== actors.length) {
                ...
                1 === actors.length && game.user.character && actors[0] === game.user.character ? ui.notifications.info(game.i18n.format("SR.CompendiumBrowser.AddedItemToCharacter", {
                    item: item.name,
                    character: game.user.character.name
                })) : ui.notifications.info(game.i18n.format("SR.CompendiumBrowser.AddedItem", {
                    item: item.name
                }))
