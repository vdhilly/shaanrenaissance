export class PersonnageSheetTabManager {
    constructor(actor, link) {
        this.actor = actor, this.link = link, renderTemplate(`systems/shaanrenaissance/templates/actors/${actor.type}/manage-tabs.hbs`).then((template => {
    ...
    onClose() {
        var _a, _b;
        const tabs = Array.from(null !== (_b = null === (_a = this.link.closest("nav")) || void 0 === _a ? void 0 : _a.querySelectorAll("a.item[data-tab]")) && void 0 !== _b ? _b : []);
